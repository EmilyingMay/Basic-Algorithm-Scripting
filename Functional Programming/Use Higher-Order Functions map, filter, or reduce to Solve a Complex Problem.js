...
// like map(), filter(), and reduce(), you now
// get to apply them to solve a more complex challenge.
...
// when an array of real numbers is passed to it. An example of an
// array of real numbers is [-3, 4.8, 5, 3, -3.2].
